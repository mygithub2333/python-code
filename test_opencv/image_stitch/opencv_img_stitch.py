...
def stitch_image(img1,img2, H):
    ...
    result_dims = np.concatenate((img2_dims,img1_transform),axis=0)#axis = 0 横向拼接
    print(result_dims)
...
#读取两张图片
img1 =cv2.imread("test_opencv\map1.png")

img2 =cv2.imread("test_opencv\map2.png")
...
resuly_image = stitch_image(img1,img2, H)       
...
cv2.imshow("input img",resuly_image)
cv2.waitKey(0)
